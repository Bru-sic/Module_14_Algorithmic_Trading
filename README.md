...
# Analysis Report - Step 1: Tune the training algorithm by adjusting the size of the training dataset
...
# Analysis Report - Step 2: Tune the trading algorithm by adjusting the SMA input features. 
...
Note: * A training window of 18 months was used for scenario 10 as this appeared to be ideal based on tests in Step 1. A training window of 3 months was used for scenarios 3 to 9 to maintain a constant comparison while other variables  changed. 
...
# Analysis Report - Step 3: Backtest the new model to evaluate its performance.
### Parameters
...
## Results
Predicted strategy return (adaBoost): 415.44%

| |precision |recall |f1-score |support|
|---:        |---:     |---:  |---:    |---:   |
|        -1.0|0.70|0.10|0.18|1430|
|         1.0|0.58|0.97|0.73|1843|
|            |         |      |        |       |
|    accuracy|    |    |0.59|3273|
|   macro avg|0.64|0.54|0.45|3273|
|weighted avg|0.64|0.59|0.49|3273|



![AdaBoost Classifier: Training:18 months; Short SMA: 2 days; Long SMA: 90 days](./Images/AdaBoost_Classifier_t_18m_sSMA_2d_lSMA_90d.png)


* ***Question 1.*** Did this new model perform better or worse than the provided baseline model?   
***Answer:*** Comparing the baseline model results (151.76%) against the AdaBoost classifier results (415.44%) it is evident that the AdaBoost classifier performed significantly better.   

* ***Question 2.*** Did this new model perform better or worse than your tuned trading algorithm?   
***Answer:*** Comparing the best tuned trading algorither (183.03%) against the AdaBoost classifier results (415.44%), again, it is evident that the AdaBoost classifier performed significantly better.
